        ...
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-5">
              ...
              <h3>KEPADA</h3>
              <strong><?=$data_invoice[0]->nama_konsumen;?></strong><br/>
              <?=$data_invoice[0]->alamat;?>
              <br /><?=$data_invoice[0]->telp;?>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <td>1</td>
                      <td><?=$data_invoice[0]->nama_barang;?></td>
                      <td><?=$data_invoice[0]->qty;?></td>
                      <td align="right"><?=number_format($data_invoice[0]->harga_barang);?></td>
                      <td align="right"><?=number_format($data_invoice[0]->harga);?></td>
                    </tr>
                  </tbody>
                  <tfoot>
                    <tr>
