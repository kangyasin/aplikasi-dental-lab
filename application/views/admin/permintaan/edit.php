        ...
        <div class="content-wrapper">
        	...
        	<section class="content-header">
                  ...
                  <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url();?>admin/master/permintaan/<?php echo $menuid;?>">Permintaan</a></li>
          ...
          <div class="box box-primary">
            ...
            <form action="<?php echo  base_url();?>admin/transaction/edit_process_permintaan/<?php echo $menuid.'/'.$ID;?>" method="post" enctype="multipart/form-data">
                          ...
                          <select name="supplier" class="form-control" required>
														...
														<label>
															...
															<label>
																...
																<input type="text" class="form-control docs-date" id="datepicker" name="tanggal_permintaan" data-date-format="yyyy-mm-dd" value="<?=$data_edit[0]->tanggal_permintaan;?>">
