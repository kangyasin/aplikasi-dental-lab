...
<body>
  <div class="login">
    <center>
  	<img src="<?php echo base_url();?>assets/img/logo2.png" width="150" style="margin:0 auto;"/>
  </center>
	<div style="float:left; font-size:16px; font-weight:bold; color:#fff; text-align:center; width:300px;">
    </div>
